...
GetCbrfcFile cbrfcUrl,downloadLocation,"GJLOCUNREG.espmvol.5yr.adj.csv"
...
Function GetCbrfcFile(cbrfcUrl,downloadLocation,fileName)
	...
	xHttp.Send
	If fileName = "GJLOCUNREG.espmvol.5yr.adj.csv" Then
		fileName = "GJNC2LOC.espmvol.5yr.adj.csv"
	End If
